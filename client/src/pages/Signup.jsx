                ...
                <div className="justify-center w-full text-center">
                    <form id="sign-up-form" className="m-auto my-5 bg-filter rounded-xl text-center border">
                        ...
                        <div className="w-full px-1 mx-auto my-5 justify-center">
                            ...
                            <input className="w-11/12 input-field" id="sign-up-name" name="email" type="text" required placeholder="Full name">
                            </input>
                        </div>    
                        <div className="w-full px-1 mx-auto my-5 justify-center">
                            <label className="w-5/6 mx-auto text-left block mb-2 text-xs font-bold tracking-wide text-color uppercase"> Email: </label>
                            <input className="w-11/12 input-field" id="sign-up-email" name="email" type="text" required placeholder="Email...">
                            </input>
                        </div>
                        <div className="w-full px-1 mx-auto my-5">
                            ...
                            <input className="w-11/12 input-field" id="sign-up-password" name="password" type="password" required placeholder="Minimum 8 Characters... ">
                            </input>
                        </div>
                        <div className="w-full px-1 mx-auto my-5">
                            ...
                            <input className="w-11/12 input-field" id="sign-up-repeat-password" name="repeat-password" type="password" required placeholder="Minimum 8 Characters... ">                            
                            </input>
                        </div>
